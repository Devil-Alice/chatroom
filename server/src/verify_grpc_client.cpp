...
VerifyGrpcClient::VerifyGrpcClient()
{
    ...
    grpc_stub_pool_.reset(new GrpcStubPool<VerifyService, VerifyService::Stub>(10, host, port));
}
...
GetVerifyResponse VerifyGrpcClient::get_rerify_code(std::string phone)
{
    ...
    // 获取stub
    std::unique_ptr<VerifyService::Stub> stub = grpc_stub_pool_->get_grpc_stub();
